...
This program translates a single .vm file, or a collection of .vm files contained in the same directory, into a single .asm file using Hack assembly language. This VM translator implements all commands of the VM language, including program flow and function calls.
...
For example, if you are in /Users/yourname/code/YapE-LynnProject8/src, and you type:
